...
export default async function(request:Request){
  ...
  switch (action){
    ...
    case "initSystemBot":
      ...
      const u111 = await User.getFromCache(auth_uid);
      payload.currentUser = u111!.getUserInfo();
      payload.userSetting = await u111!.getUserSetting()
      break;
    case "loadChats":
    ...
    case "protoUser":
      ...
      break
    case "protoChat":
      const c:ApiChat = {"type":"chatTypePrivate","id":"4002","title":"Bot Father","usernames":[],"isMuted":false,"isMin":false,"hasPrivateLink":false,"isSignaturesShown":false,"accessHash":"","isVerified":false,"isJoinToSend":false,"isJoinRequest":false,"isForum":false,"isListed":true,"settings":{"isAutoArchived":false,"canReportSpam":false,"canAddContact":false,"canBlockContact":false}}
      const obj = new Chat()
      obj.setChatInfo(c)
      await obj.save();
    ...
    case "protoMsg":
      ...
      payload.get_msg.content!.photo!.thumbnail!.dataUri = payload.get_msg.content.photo.thumbnail.dataUri.toString('base64')
